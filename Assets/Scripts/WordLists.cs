...
public static class WordLists
{
    ...
    // 3 syllables, less common, clusters, blends, longer words, trickier Filipino-challenging phonemes.
    ...
    // 4+ syllables, uncommon words, multiple difficult phonemes in a row (clusters, long vowels, /th/ + /r/, /v/ + /z/, etc.).
